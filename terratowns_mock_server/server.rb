...
class TerraTownsMockServer < Sinatra::Base
  ...
  def find_user_by_bearer_token
    ...
    # if we cant find it or if it does not match return an error
    ...
    # Was there a user_uuid in http request payload
    if params['user_uuid'].nil?
      error 401, "a1002 Failed to authenicate, bearer token invalid and/or teacherseat_user_uuid invalid"
    end

    # the code and users_uuid should be matchig for this user
  ...
  post '/api/u/:user_uuid/homes' do
    ...
    begin
      # Sinatra does not auto parse json body as params
    ...
    # printing the variables out to console for easire reading and debuging
    puts "name #{name}"
    ...
    # Creating a new Home model and the atrributes
    home = Home.new
    home.town = town
    home.name = name
    ...
    # Ensure our validations check pass
    # otherwise return the error messages back as JSON
    unless home.valid?
  ...
  # UPDATE
  # verry similar to CREATE action
